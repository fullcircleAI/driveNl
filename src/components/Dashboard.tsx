            ...
            <div className="progress-tracker">
              <div className="main-progress-bar">
                <div className="progress-bar-bg">
                  <div className="progress-bar-fill orange" style={{ width: `${Math.min(((tracker?.totalStudyTime || 0) / 1440) * 100, 100)}%` }}></div>
                </div>
              </div>
              <div className="progress-stats">
                ...
                <div className="progress-stat">
                  <div className="stat-number">{formatTime(tracker?.remainingTime || 1440)}</div>
                  <div className="stat-label">TIME LEFT</div>
                  <div className="progress-indicator">
                    <div className="progress-bar-bg">
                      <div className="progress-bar-fill" style={{ width: `${Math.min(((tracker?.remainingTime || 1440) / 1440) * 100, 100)}%` }}></div>
                    </div>
                  </div>
                </div>
              </div>
